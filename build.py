...
<section class="section"><div class="container about">
  ...
  <div class="about__content reveal" data-delay="120"><span class="eyebrow">Orgullo boliviano</span><h2>Taza de Calidad Café Presidencial</h2>
    <p class="lead">El torneo nacional del café boliviano, organizado por el <b>Comité Torneo Presidencial</b> bajo estándares de catación de la SCA, con subasta internacional de los mejores lotes y publicación transparente de resultados, ventas y procedimientos.</p>
