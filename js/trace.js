...
(function(){
  "use strict";
  var DB = {
    "LOT-000123":{coop:"ASOCAFE Taipiplaya",com:"Comunidad Taipiplaya",region:"Caranavi · La Paz",prod:"Productor verificado (anonimizado)",camp:"Campaña 2025–2026",cos:"12 jul 2025",proc:"Lavado",vol:"1.380 kg",sca:"86,5",alt:"1.560 msnm",area:"2,4 ha",var:"Caturra / Typica",sis:"Bajo sombra (SAF)",dds:"DDS-BO-2026-000123",ddsf:"14 ago 2025",certs:["Orgánica UE/USDA","Fairtrade FLO"],lat:-15.8386,lng:-67.5603},
    "LOT-000456":{coop:"Coop. Antofagasta",com:"Munaypata",region:"Coroico · La Paz",prod:"Productor verificado (anonimizado)",camp:"Campaña 2025–2026",cos:"3 ago 2025",proc:"Honey",vol:"920 kg",sca:"87,75",alt:"1.640 msnm",area:"1,8 ha",var:"Java / Geisha",sis:"Agroforestal",dds:"DDS-BO-2026-000456",ddsf:"21 ago 2025",certs:["Orgánica UE/USDA"],lat:-16.190,lng:-67.730},
    "LOT-000789":{coop:"Coop. San Juan",com:"Atén",region:"Apolo · La Paz",prod:"Comité de Mujeres (Kullaka)",camp:"Campaña 2025–2026",cos:"19 jul 2025",proc:"Natural",vol:"640 kg",sca:"88,25",alt:"1.720 msnm",area:"1,2 ha",var:"Typica",sis:"Bajo sombra (SAF)",dds:"DDS-BO-2026-000789",ddsf:"30 ago 2025",certs:["Orgánica UE/USDA","Fairtrade FLO"],lat:-14.720,lng:-68.420}
  };
  document.addEventListener("DOMContentLoaded", function(){
    ...
    function card(d){
      ...
      return ''+
      '<div class="lot__hd"><div><div class="k">Lote</div><h3>'+box.dataset.code+'</h3></div>'+
      '<div class="lot__verified"><span class="dot"></span> Verificado · EUDR</div></div>'+
      '<div class="lot__grid">'+
      '<div><h4>Origen</h4>'+row("Cooperativa",d.coop)+row("Comunidad",d.com)+row("Región",d.region)+row("Productor",d.prod)+
      ...
      '<div><h4>Parcela</h4><div id="lotMap"></div>'+
      ...
      '<div class="chipset"><div class="chip-card"><div class="k">Variedad</div><b>'+d.var+'</b></div><div class="chip-card"><div class="k">Sistema</div><b>'+d.sis+'</b></div></div></div>'+
      '</div>'+
    ...
    function show(code){
      ...
      if(typeof L !== "undefined"){
        ...
        miniMap = L.map(mEl, {scrollWheelZoom:false, attributionControl:false, zoomControl:false}).setView([d.lat,d.lng], 12);
        L.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png",{subdomains:"abcd",maxZoom:19}).addTo(miniMap);
        var pin = L.divIcon({className:"",html:'<div style="width:16px;height:16px;border-radius:50% 50% 50% 0;background:#6E0D12;transform:rotate(-45deg);border:2px solid #fff"></div>',iconSize:[16,16],iconAnchor:[8,16]});
